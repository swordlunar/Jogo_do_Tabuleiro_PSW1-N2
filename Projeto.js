...
//A mudança do background é dada de acordo ao último "ponto turistico" que foi ultrapassado
	if (posicao>=3 && posicao<8) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image1.jpg)').fadeIn(5);
	else if (posicao>=8 && posicao<11) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image2.jpg)').fadeIn(5);
	else if (posicao>=11 && posicao<16) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image3.jpg)').fadeIn(5);
	else if (posicao>=16 && posicao<23) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image4.jpg)').fadeIn(5);
	else if (posicao>=23 && posicao<30) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image5.jpg)').fadeIn(5);
	else if (posicao>=30 && posicao<32) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image6.jpg)').fadeIn(5);
	else if (posicao>=32 && posicao<37) 
		$('#pagina').css('background-image', 'url(Design/Backgrounds/image7.jpg)').fadeIn(5);
